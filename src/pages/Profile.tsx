            ...
            <Card className="bg-white shadow-sm">
              ...
              <CardContent>
                <nav className="flex flex-col space-y-2">
                  ...
                  <button className="flex items-center p-3 rounded-md hover:bg-coffee-green-light/20 text-coffee-brown hover:text-coffee-green transition-colors text-left">
